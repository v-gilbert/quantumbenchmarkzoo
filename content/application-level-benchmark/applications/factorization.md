...
<div class="center">
  <img src="/img/application-level-benchmark/RSA_cryptosystem.png" class="img-large" alt="Scheme describing the RSA cryptosystem. Alice generates the public and private keys. Bob uses Alice's public key to encrypt the message. The resulting ciphertext is sent to Alice, who is able to decrypt it with her private key."/>
</div>
where $$p$$ and $$q$$ are big prime numbers, $$e$$ can be choosen arbitrarily (often, $$e = 65537 = 2^{16} + 1$$) as long as $$e$$ is coprime to $$(p-1)(q-1)$$. There are other important criteria to choose $$p$$, $$q$$ and $$e$$ for RSA security {% cite chen2023dss %}, but it is not the main subject here.
...
**List of acronyms:**  
**FE**: Factorization Equations  
**FER**: Factorization Equations Reduction  
**GBR**: Gröbner Basis Reduction  
**NE**: Not Explicited (so it was deduced by the contributor)  
