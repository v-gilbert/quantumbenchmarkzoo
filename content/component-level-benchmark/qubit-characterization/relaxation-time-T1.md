...
- Some uncertainty can arise from the T1 measurement if the preparation, $$X$$ gate and measurement operations are not well calibrated.
- Measuring $$T1$$ for quantum annealers can be mis-leading, essentially because quantum annealers can operate sucessfully beyond this timescale (see {% cite lall2025review %} and {% cite Dickson2013 %} for interesting discussions on this subject).

## Implementation Examples

A tutorial is available in the <a href="https://gitlab.npl.co.uk/qc-metrics-and-benchmarks/qcmet/-/tree/main/tutorials/qubit_quality_metrics/t1?ref_type=heads" target="_blank">QCMet software repository</a>.
